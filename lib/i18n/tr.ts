...
export const tr: Record<Key, string> = {
  ...
  p3: "p3 düşük",
  /* alt projeler */
  subProjectsTitle: "Alt projeler",
  subProjectsSub: "Bu çalışma alanının altındaki kardeşler — farklı yollar, aynı hesap",
  noSubProjects: "Henüz alt proje yok. Ajan bu çalışma alanı içinde yeni bir kod tabanına geçtiğinde bir tane ekle.",
  newSubProject: "+ yeni alt proje",
  subProjectNamePh: "alt projenin adı",
  subProjectSummaryPh: "bu yol ne açıdan farklı?",
  subProjectOpenTasks: "{n} açık",
  subProjectTotalTasks: "{n} görev",
  subProjectArchived: "arşivlenmiş",
  parentProject: "Üst proje",
  subProjectOf: "{name} projesinin alt projesi",
  reparent: "Taşı",
  reparentTop: "Üst seviye",
  subProjectMoved: "Taşındı.",
  subProjectCreated: "Alt proje oluşturuldu.",
  flowTitle: "Proje akışı",
  flowBody: "Kök dallarda üst proje, ondan çıkan her dal bir alt proje. Gösterilen sayılar açık görevlerdir.",
  here: "buradasın",
  subProjectBadge: "alt proje",
