export const en = {
  ...
  subProjectsSub: "Siblings under this workspace — different paths, same account",
  noSubProjects: "No sub-projects yet. Add one when the agent moves into a new code base inside this workspace.",
  newSubProject: "+ new sub-project",
  subProjectNamePh: "name of the sub-project",
  subProjectSummaryPh: "what's different about this path?",
  subProjectOpenTasks: "{n} open",
  subProjectTotalTasks: "{n} tasks",
  subProjectArchived: "archived",
  parentProject: "Parent project",
  subProjectOf: "Sub-project of {name}",
  reparent: "Move to",
  reparentTop: "Top level",
  subProjectMoved: "Moved.",
  subProjectCreated: "Sub-project created.",
  flowTitle: "Project flow",
  flowBody: "The parent at the root, each sub-project as a branch off it. Counts shown are open tasks.",
  here: "you are here",
  subProjectBadge: "sub-project",
